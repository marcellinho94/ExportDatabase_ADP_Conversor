...
public class MainController implements Initializable {
  ...
  @FXML private ChoiceBox<String> cboxDatabase;
  @FXML private TextField txtServer;
  @FXML private TextField txtUser;
  @FXML private PasswordField pswPassword;
  @FXML private Button btnMigration;
  @FXML private Button btnConnection;
  @FXML private TextArea txtaConsole;
  @FXML private CheckBox cbxCreateTable;
  ...
  public void connect() {
    try {
      ...
      // Database connection
      con =
          new ConexaoDiretaBanco(
              txtServer.getText(), "master", txtUser.getText(), pswPassword.getText());
      ...
      if (!Utilitario.listaVazia(result)) {
        result.forEach(e -> listDatabase.add(e[0].toString()));
      } else {
