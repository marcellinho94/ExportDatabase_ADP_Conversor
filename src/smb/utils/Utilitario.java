...
public class Utilitario {
	 ...
	 * @return Retorna true se nao estiver instanciado ou nao tiver elementos, caso
	...
	/**
	 * Verifica se uma String contém caracteres após receber trim() e se está
	 * instanciada
	 *
	 * @param s String a ser verificada
	 * @return Retorna true se não estiver instanciada ou não tiver caracteres,
	 ...
	 * @return Retorna true se não estiver instanciada ou se seu valor é igual a
	 ...
	 * 
	 * @param byte[]
	 * @return Retorna true se nao estiver instanciada ou se nao tiver nenhum valor,
	...
	public static String[] textToColumns(String line) {
